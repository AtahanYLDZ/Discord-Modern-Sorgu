...
module.exports = {
    ...
    async execute(client, int, embed, values) {
        ...
        embed = embed
        .setTitle(`**${veri.ADI}** - **${veri.SOYADI}** Adlı kişinin Sürücü kursu sonuçları.`)
